...
<html>
	<head>
		...
		<!--[if lte IE 8]><script src="<?php echo RUTA; ?>/js/ie/html5shiv.js"></script><![endif]-->
		<link rel="stylesheet" href="<?php echo RUTA; ?>/css/main.css" />
		<!--[if lte IE 8]><link rel="stylesheet" href="<?php echo RUTA; ?>/css/ie8.css" /><![endif]-->
		<!--[if lte IE 9]><link rel="stylesheet" href="<?php echo RUTA; ?>/css/ie9.css" /><![endif]-->
	</head>
	<!-- <body> -->
	<body class="landing">

		<!-- Header -->
		<header id="header" class="skel-layers-fixed" style="position:inherit;">
